...
const generativeAITools: Tool[] = [
  {
    name: "ChatGPT",
    description:
      "OpenAI's conversational AI for brainstorming, drafting, coding, analysis, and creative tasks. Supports text, image, and file uploads.",
  ...
  },
  {
    name: "Claude",
    description:
      "Anthropic's AI assistant focused on safety and nuance. Excels at long-document analysis, careful reasoning, and following complex instructions.",
  ...
  },
  {
    name: "Gemini",
    description:
      "Google's multimodal AI integrated with Google Workspace. Strong at search-grounded answers, image understanding, and data analysis.",
  ...
  },
  {
    ...
    description:
      "AI assistant integrated into Microsoft 365 apps. Summarize emails, generate documents, analyze spreadsheets, and create presentations.",
  ...
  },
  {
    name: "Perplexity",
    description:
      "AI-powered search engine that provides sourced, cited answers. Combines web search with AI summarization for research-quality responses.",
  ...
  },
  {
    name: "Pi",
    description:
      "Inflection AI's personal assistant designed for natural, empathetic conversations. Great for brainstorming, learning, and casual exploration.",
  ...
  },
  {
    name: "Mistral",
    description:
      "European open-weight AI models with strong multilingual capabilities. Offers Le Chat as a free conversational interface and API access.",
  ...
  },
  {
    name: "Poe",
    description:
      "Quora's platform offering access to multiple AI models (GPT-4, Claude, Gemini, and more) in a single interface. Compare responses across models.",
...
/* ------------------------------------------------------------------ */
/*  Category data — every category with its tools listed              */
/* ------------------------------------------------------------------ */
...
/* ------------------------------------------------------------------ */
/*  Helper: reorder generative tools by audience                      */
/* ------------------------------------------------------------------ */
function reorderGenerativeTools(
  tools: Tool[],
  recommended: string[],
): Tool[] {
  ...
  // Preserve recommended order for top tools
  top.sort(
    (a, b) => recommended.indexOf(a.name) - recommended.indexOf(b.name),
  );
  return [...top, ...rest];
}

/* ------------------------------------------------------------------ */
/*  Helper: reorder categories by audience                            */
/* ------------------------------------------------------------------ */
...
export default function PlaygroundPage() {
  ...
  const orderedGenerativeTools = useMemo(() => {
    ...
    return reorderGenerativeTools(
      generativeAITools,
      config.recommendedGenerativeTools,
    );
  }, [config]);
      ...
      <div className="mx-auto max-w-7xl px-5 py-20 sm:py-28 lg:px-8">
        ...
        <div className="max-w-3xl">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              {config ? (
                <>
                  {config.intro} Curated by the GRC AI Task Force from the{" "}
                  <Link
                ...
                <>
                  Discover AI tools for every use case — from writing to
                  research to multimedia. Curated by the GRC AI Task Force
                  from the{" "}
                  <Link
                    href="https://libguides.greenriver.edu/AITaskforce"
                    className="underline decoration-gator-green/40 underline-offset-2 transition-colors hover:text-gator-green"
        ...
        <AnimatePresence>
          {config && (
            ...
            >
              <div
                className={`flex items-start gap-3 rounded-2xl border px-5 py-4 ${config.tipBg} ${config.tipBorder}`}
              >
                <svg
                  className={`mt-0.5 h-5 w-5 shrink-0 ${config.tipColor}`}
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth={2}
                ...
                <p className={`font-body text-sm font-medium ${config.tipColor}`}>
                  {config.tip}
                </p>
              </div>
            </motion.div>
        ...
        <section className="mt-20">
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2">
            {guidelines.map((g) => (
              <div
                key={g.title}
                className={`flex gap-5 rounded-3xl border border-ever-green/[0.06] p-7 ${g.color}`}
              >
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-ever-green/[0.06]">
                  <svg
                    className="h-6 w-6 text-ever-green"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    strokeWidth={1.5}
        ...
        <section>
          ...
          >
            ...
            <motion.div
              variants={fadeInUp}
              custom={0}
              className="group relative flex flex-col rounded-3xl border-2 border-gator-green/20 bg-gradient-to-br from-gator-green/[0.04] to-transparent p-8 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-elevated sm:col-span-2 lg:col-span-1"
            >
              <span className="mb-2 inline-flex w-fit items-center gap-1.5 rounded-pill bg-gator-green/15 px-2.5 py-0.5 font-body text-xs font-bold uppercase tracking-wider text-gator-green">
                Featured
              </span>
              ...
              <p className="mt-1 font-body text-sm text-pine-cone/70">
                {generativeAITools.length} tools — ChatGPT, Claude, Gemini
                &amp; more
              </p>
              <a
                href="#generative-ai"
                className="mt-4 inline-flex items-center gap-1.5 font-body text-sm font-semibold text-gator-green transition-colors hover:text-ever-green"
              >
                View full directory
                <svg
                  className="h-4 w-4"
            ...
            {/* Other categories — reordered by audience */}
            {orderedCategories.map((cat, i) => {
              const pillColor =
                categoryPillColors[cat.name] ??
              ...
              return (
                <motion.div
                  ...
                  variants={fadeInUp}
                  custom={i + 1}
                  className={`group flex items-start gap-5 rounded-3xl border border-ever-green/[0.06] p-8 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-elevated ${cat.color}`}
                >
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-ever-green/[0.06]">
                    <svg
                  ...
                  <div>
                    ...
                    <span
                      className={`mt-1 inline-flex items-center gap-1 rounded-pill border px-2 py-0.5 font-body text-xs font-semibold ${pillColor}`}
                    >
            ...
            {orderedGenerativeTools.map((tool, i) => {
              ...
              return (
                <motion.div
                  ...
                  variants={fadeInUp}
                  custom={i}
                  className="group flex flex-col rounded-3xl border border-ever-green/[0.06] bg-white p-6 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-elevated"
                >
                  <div className="mb-3 flex flex-wrap items-center gap-1.5">
                    <span className="inline-flex w-fit items-center rounded-pill bg-gator-green/10 px-2.5 py-0.5 font-body text-[11px] font-bold uppercase tracking-wider text-gator-green">
                      Generative AI
                    </span>
                    {recommended && config && (
                      <motion.span
                        ...
                        className={`inline-flex items-center gap-1 rounded-pill px-2 py-0.5 font-body text-[11px] font-bold uppercase tracking-wider ${config.badgeBg} ${config.badgeColor}`}
                      >
                        <svg
                          className="h-3 w-3"
                          fill="currentColor"
                  ...
                  <div className="mt-4 flex flex-wrap gap-1.5">
                    {tool.tags.map((tag) => (
                      <span
                        key={tag}
                        className="rounded-pill bg-ever-green/[0.05] px-2 py-0.5 font-body text-xs text-pine-cone/70"
                      >
                        {tag}
                      </span>
                    ))}
                  ...
                  <div className="mt-3 flex items-center justify-between border-t border-ever-green/[0.06] pt-3">
                    <p className="font-body text-xs text-pine-cone/60">
                      {tool.pricing}
                    </p>
                    <a
                      href={tool.url}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-1 font-body text-xs font-semibold text-sky-blue transition-colors hover:text-ever-green"
                    >
                      Visit
            ...
            <table className="w-full min-w-[600px] text-left">
              <thead>
                <tr className="border-b border-ever-green/[0.08]">
                  <th className="px-6 py-4 font-heading text-sm font-bold uppercase tracking-wider text-ever-green">
                    Tool
                  </th>
                  <th className="px-6 py-4 font-heading text-sm font-bold uppercase tracking-wider text-ever-green">
                    Best For
                ...
                {orderedGenerativeTools.map((tool, i) => {
                  ...
                  return (
                    <tr
                      key={tool.name}
                      className={
                        i < orderedGenerativeTools.length - 1
                    ...
                    >
                      <td className="px-6 py-3.5 font-heading text-sm font-semibold text-ever-green">
                        <span className="flex items-center gap-2">
                          ...
                          {recommended && config && (
                            <span
                              className={`inline-flex items-center rounded-pill px-1.5 py-0.5 text-[10px] font-bold uppercase ${config.badgeBg} ${config.badgeColor}`}
                            >
                              <svg
                      ...
                      <td className="px-6 py-3.5 font-body text-sm text-pine-cone/60">
                        {tool.bestFor}
                      </td>
                      <td className="px-6 py-3.5 font-body text-sm text-pine-cone/70">
                        {tool.pricing}
                      </td>
                      {audience !== "student" && (
                        <td className="px-6 py-3.5">
                          <div className="flex flex-wrap gap-1">
                            {tool.tags.map((tag) => (
                              <span
                                key={tag}
                                className="rounded-pill bg-ever-green/[0.05] px-2 py-0.5 font-body text-xs text-pine-cone/60"
                              >
                                {tag}
                              </span>
                            ))}
            ...
            {orderedCategories.map((cat, i) => {
              ...
              return (
                <motion.div
                  ...
                  variants={fadeInUp}
                  custom={i}
                  className={`rounded-3xl border border-ever-green/[0.06] p-8 ${cat.color}`}
                >
                  ...
                  <div className="mt-5 flex flex-wrap gap-2">
                    {cat.tools.map((tool) => (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="rounded-pill border border-ever-green/[0.08] bg-white/70 px-3 py-1 font-body text-sm text-pine-cone/60 transition-colors hover:border-gator-green/30 hover:text-gator-green"
                      >
                        {tool.name}
                      </a>
                    ))}
        ...
        <div className="mt-20 rounded-3xl border border-ever-green/[0.06] bg-gradient-to-br from-gator-green/[0.04] to-transparent p-10 text-center sm:p-14">
          ...
          <div className="mt-8 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
            <Link
              href="/feedback"
              className="inline-flex items-center gap-2 rounded-pill bg-grc-green px-6 py-3 font-body text-sm font-semibold text-white transition-colors hover:bg-ever-green"
            >
            ...
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 rounded-pill border border-ever-green/10 bg-white px-6 py-3 font-body text-sm font-semibold text-ever-green transition-colors hover:bg-ever-green/[0.04]"
            >
              View Full LibGuide
              <svg
                className="h-4 w-4"
